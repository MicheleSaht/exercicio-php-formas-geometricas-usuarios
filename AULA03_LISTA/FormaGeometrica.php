...
<body>
    ...
    <header>
        <nav>
            <ul>
                <a href="#"><svg class="logo" href="#main" width="48" height="24" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 -1 100 50" fill="#ffffff">
                        <path
    ...
    <MAIN>
        ...
        $usuario = new Usuario('Michele', 11999928096, "Rua Manuel 1187", 10);
        $funcionario = new Funcionario("Maria", "11999928096", "Rua B, São Paulo", 2500.00);
...
<footer>
    ...
    <a href="https://github.com/MicheleSaht/exercicio-php-formas-geometricas-usuarios"><svg fill="#ffffff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
